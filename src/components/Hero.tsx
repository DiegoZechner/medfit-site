      ...
      <div className="page-container grid gap-10 py-14 md:grid-cols-2 md:items-center md:py-20">
        <div className="space-y-6">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-ink md:text-4xl lg:text-5xl">
            ...
            <span className="block text-muted">Sie sich wieder wohlfühlen.</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/termin"
              className="rounded-full bg-slate px-6 py-2.5 text-sm font-medium text-white shadow-sm transition hover:-translate-y-[1px] hover:opacity-90 hover:shadow-md"
            >
              Kostenlose Beratung buchen
            </Link>
            <Link
              href="/koerperformung"
              className="rounded-full border border-line bg-white px-6 py-2.5 text-sm font-medium text-ink transition hover:border-slate-300 hover:bg-shell"
            >
              Körperbehandlungen ansehen
            </Link>
          </div>
          <div className="flex flex-wrap gap-4 text-xs font-medium text-muted md:text-sm">
        ...
        <div className="md:justify-self-end">
          <div className="relative rounded-2xl-3xl border border-line bg-white/80 p-6 shadow-md shadow-slate-900/5 backdrop-blur">
            ...
            <ul className="mt-5 grid grid-cols-2 gap-3 text-sm text-muted">
              <li className="rounded-xl-2xl bg-shell px-4 py-3 shadow-sm shadow-slate-900/3">
                Doppelkinn &amp; Oberarme
              </li>
              <li className="rounded-xl-2xl bg-shell px-4 py-3 shadow-sm shadow-slate-900/3">
                Bauch &amp; Hüftgold

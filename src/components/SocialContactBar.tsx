...
export function SocialContactBar() {
  return (
    <div className="flex flex-wrap gap-4 items-center">
      ...
      <a
        href="https://www.instagram.com/medfitbeauty/"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://www.facebook.com/medfitdornbirn/"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        ...
        className="w-10 h-10 rounded-full bg-slate text-white flex items-center justify-center hover:scale-110 transition-transform shadow-sm"
        aria-label="Phone"
      >
      ...
      <a
        href="mailto:office@med-fit.com"
        className="w-10 h-10 rounded-full bg-ink text-white flex items-center justify-center hover:scale-110 transition-transform shadow-sm"
        aria-label="Email"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
